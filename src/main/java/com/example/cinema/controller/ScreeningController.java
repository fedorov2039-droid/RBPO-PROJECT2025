...
public class ScreeningController {
    ...
    public ScreeningController(ScreeningRepository repository) { this.repository = repository; }

    @GetMapping
    public List<Screening> getAll() { return repository.findAll(); }

    @PostMapping
    public Screening create(@RequestBody Screening screening) { return repository.save(screening); }
